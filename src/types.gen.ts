...
export type FinishBatchError = FinishBatchErrors[keyof FinishBatchErrors];

export type FinishBatchResponses = {
    /**
     * Empty response when the update was successful. A future improvement is to include the changed transactions.
     */
    204: void;
...
export type FinishBatchResponse = FinishBatchResponses[keyof FinishBatchResponses];
